...
#ifndef _BURGERS_MPI_H__
#define _BURGERS_MPI_H__
...
#define LOOP 16 // For Async implementation
...
extern "C"
{
	...
	void Compute_Adv_y_Async(dim3 thread_blocks_halo, dim3 threads_per_block, cudaStream_t aStream, 
		...
		REAL* d_s_u, REAL* d_s_Lu);
	void Compute_Adv_z_Async(dim3 thread_blocks_halo, dim3 threads_per_block, cudaStream_t aStream, 
