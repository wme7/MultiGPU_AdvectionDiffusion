...
void Call_Adv_x(dim3 numBlocks, dim3 threadsPerBlock, cudaStream_t aStream, unsigned int pitch, unsigned int Nx, unsigned int Ny, unsigned int Nz, REAL dx, REAL *u, REAL *Lu);
void Call_Adv_y(dim3 numBlocks, dim3 threadsPerBlock, cudaStream_t aStream, unsigned int pitch, unsigned int Nx, unsigned int Ny, unsigned int Nz, REAL dy, REAL *v, REAL *Lv);
