...
void Call_Adv_L(dim3 numBlocks_x, dim3 threadsPerBlock_x, dim3 numBlocks_y, dim3 threadsPerBlock_y, cudaStream_t aStream, size_t pitch_bytes, unsigned int pitch, cudaChannelFormatDesc *desc, unsigned int Nx, unsigned int Ny, unsigned int Nz, REAL dx, REAL dy, REAL *u, REAL *Lu);
