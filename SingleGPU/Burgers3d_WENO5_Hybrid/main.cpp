...
int main(int argc, char** argv){
    ...
    while (t < tEnd)
    {
        ...
        for(step=1; step<=3; step++) {
            Call_Adv_L(numBlocks_X,threadsPerBlock_X,numBlocks_Y,threadsPerBlock_Y,compute_stream,pitch_bytes,pitch,&desc,Nx,Ny,Nz,dx,dy,d_u,d_Lu);
    ...
    PrintSummary("Burgers-3D GPU-WENO5", "Texture+Shared Mem", compute_timer, HtD_timer, DtH_timer, gflops, it, Nx, Ny, Nz);
