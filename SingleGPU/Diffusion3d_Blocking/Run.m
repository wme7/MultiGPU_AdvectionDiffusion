...
% =========================== HeatEq3D (13-pt) =======================
% Optimization                                 :  PitchMem + Blocking
% Kernel time ex. data transfers               :  5.220000 seconds
% ===================================================================
% Total effective GFLOPs                       :  7.417439
% ===================================================================
...
fID = fopen('run.sh','wt');
fprintf(fID,'make\n');
args = sprintf('%1.1f %1.2f %1.2f %1.2f %d %d %d %d %d %d %d',C,L,W,H,nx,ny,nz,iter);
