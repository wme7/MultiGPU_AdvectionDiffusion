...
#define FLOPS 8.0
#define k_loop 16 // for asyncronous kernel implementation
...
void Call_Lu3d(dim3 numBlocks, dim3 threadsPerBlock, cudaStream_t aStream, unsigned int pitch, unsigned int nx, unsigned int ny, unsigned int nz, REAL *u, REAL *Lu);
void Call_RK3d(dim3 numBlocks, dim3 threadsPerBlock, cudaStream_t aStream, unsigned int step, unsigned int pitch, unsigned int nx, unsigned int ny, unsigned int nz, REAL dt, REAL *u, REAL *uo, REAL *Lu);
}
