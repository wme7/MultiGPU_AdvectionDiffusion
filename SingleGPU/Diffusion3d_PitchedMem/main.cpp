...
int main(int argc, char** argv)
{
    ...
    for(unsigned int iterations = 0; iterations < max_iters; iterations++)
    {
        ...
        // Runge Kutta Step 1
        Call_Lu3d(numBlocks3D,threadsPerBlock3D,compute_stream,pitch,Nx,Ny,Nz,d_u,d_Lu);
    ...
    PrintSummary("HeatEq3D (13-pt)", "Pitched Memory", tCPU, gflops, tFinal, max_iters, Nx, Ny, Nz);
