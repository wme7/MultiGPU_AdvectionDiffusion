...
void Call_Lu2d(dim3 numBlocks, dim3 threadsPerBlock, cudaStream_t aStream, unsigned int nx, unsigned int ny, REAL *u, REAL *Lu);
void Call_RK2d(dim3 numBlocks, dim3 threadsPerBlock, cudaStream_t aStream, unsigned int step, unsigned int nx, unsigned int ny, REAL dt, REAL *u, REAL *uo, REAL *Lu);
}
