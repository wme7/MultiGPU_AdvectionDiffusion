function res = WENO5resAdv_Z(w,flux,dflux,dz,N)
% *************************************************************************
...
W=cat(3,w(:,:,1), w(:,:,1),w(:,:,I-2),w(:,:,N),w(:,:,N),w(:,:,N));
hn=zeros(size(W));
hp=zeros(size(W));
...
%% Compute finite difference residual term, df/dz.
res = (hp(:,:,I)+hn(:,:,I)-hp(:,:,I-1)-hn(:,:,I-1))/dz;